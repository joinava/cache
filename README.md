...
The package provides **four** functions for wrapping a producer with a cache. They split along two axes — single vs. bulk, and "lookup" vs. "compute":
